...
import config
from LyraMusic import Carbon, YouTube, app
from LyraMusic.core.call import Lyra
from LyraMusic.misc import db
from LyraMusic.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from LyraMusic.utils.exceptions import AssistantErr
from LyraMusic.utils.inline.play import (stream_markup,
                                          telegram_markup)
from LyraMusic.utils.inline.playlist import close_markup
from LyraMusic.utils.pastebin import Lyrabin
from LyraMusic.utils.stream.queue import put_queue, put_queue_index
from LyraMusic.utils.thumbnails import gen_thumb
...
async def stream(
    ...
    if forceplay:
        await Lyra.force_stop_stream(chat_id)
